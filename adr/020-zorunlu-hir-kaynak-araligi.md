...
- Bu kararda ayrı bırakılan bütün AST varyantlarına kesin token aralığı yayma
  işi B-050, K-126/ADR-030 ile sonradan kapatıldı; başarılı parser→checker
  hattındaki HIR ifadeleri artık `Satir` zarfına düşmez.
