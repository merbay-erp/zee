...
| RFC-0009 | [Modül ve Paket Modeli](0009-modul-ve-paket.md) | **geçici kabul** (birim + proje + yerel paket/kilit + public kaynak ABI); registry taşıma/cache çekirdeği çalışır, exact proje bağı açık | K-029, K-076, K-078, K-086, K-095, K-135 |
...
| RFC-0020 | [Paket Yayını ve Registry Güven Zinciri](0020-paket-yayini-ve-registry-guveni.md) | **geçici kabul** (K-094 yayın; K-095 metadata; K-117 kanonik yol; K-135 taşıma/cache/offline; exact proje/CLI açık) | K-094, K-095, K-117, K-135, V1-P1-07/08, ADR-006/028 |
...
**Durum özeti (2 Eylül 2026, K-135):** 25 RFC — 2 kabul (0001, 0010),
21 geçici kabul (RFC-0020'nin yayın ve metadata doğrulama katmanı normatiftir;
taşıma/cache/offline da çalışır; exact proje/CLI tamamlanmadan uzak paket
kullanımı sözü verilmez), 2 taslak: 0012 (FFI — Faz
