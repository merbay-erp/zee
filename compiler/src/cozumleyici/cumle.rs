        ...
        let sonuc = (|| -> Result<(), Tani> {
            match cumle {
                ...
                Cumle::Olsun {
                    ...
                    let kaynak_araligi =
                        crate::hir::HirKaynakAraligi::kesin(satir, *sutun, *uzunluk)
                ...
                Cumle::Ise {
                    ...
                    if let Some(blok) = degilse {
                        ...
                        let ters = son_kol_daraltmasi.filter(|_| kollar.len() == 1).and_then(
                            |(kod, ad)| match kod {
                ...
                Cumle::HerBiri {
                    ...
                    let kaynak_adi = kaynak.as_ref().and_then(nesne_adi).ok_or_else(|| {
                    ...
                    match kap_turu {
                        ...
                        baska => {
                            return Err(Tani::yeni(
                                "T012",
                                format!(
                                    "Silme bir liste ya da sözlük ister; hedef {} türünde.",
                                    baska.adi()
                                ),
                                satir,
                                1,
                    ...
                    for (ad, deger, gorev_satiri) in gorevler.iter_mut() {
                        ...
                        if baglam.bekleyen_gorevler.contains(ad) {
                            return Err(gorev_kapsami_tanisi(
                                *gorev_satiri,
                                &format!(
                                    "\"{}\" adı aynı görev grubunda iki kez kullanılamaz.",
                                    ad
                                ),
                            ));
                        }
                    ...
                    if let Some(neden) = neden {
                        ...
                        if neden_turu != Tur::Hata {
                            return Err(Tani::yeni(
                                "T052",
                                format!(
                                    "Hatanın nedeni Hata olmalı; burada {} var.",
                                    neden_turu.adi()
                                ),
                                satir,
                                1,
                    ...
                    for taraf in [&mut *pay, &mut *payda] {
                        ...
                        if !tur.sayisal() {
                            return Err(Tani::yeni(
                                "T008",
                                format!(
                                    "Bölme sayılar arasında yapılır; burada {} var.",
                                    tur.adi()
                                ),
                                satir,
                                1,
                    ...
                    let beklenen_deger = match sozluk_turu {
                        ...
                        Tur::Sozluk(SozlukDegerTuru::Bilinmeyen) => {
                            ...
                            let yeni_deger = match deger_tur {
                                ...
                                baska => {
                                    ...
                                    .onerili(
                                        "Sözlük değeri TamSayı, Ondalık ya da Metin olabilir."
                                            .into(),
                                    ));
                                }
                            };
                        ...
                        baska => {
                            return Err(Tani::yeni(
                                "T021",
                                format!(
                                    "\"değeri ... olsun\" bir sözlük ister; hedef {} türünde.",
                                    baska.adi()
                                ),
                                satir,
                                1,
                ...
                | Cumle::Azalt {
                    ...
                    if !hedef_tur.sayisal() {
                        return Err(Tani::yeni(
                            "T006",
                            format!(
                                "Artırma/azaltma sayı ister; hedef {} türünde.",
                                hedef_tur.adi()
                            ),
                            satir,
                            1,
                    ...
                    if !miktar_tur.sayisal() {
                        return Err(Tani::yeni(
                            "T006",
                            format!(
                                "Artırma/azaltma miktarı sayı olmalı; burada {} var.",
                                miktar_tur.adi()
                            ),
                            satir,
                            1,
                    ...
                    if hedef_tur == Tur::TamSayi && miktar_tur == Tur::Ondalik {
                        return Err(Tani::yeni(
                            "T006",
                            "TamSayı hedefe Ondalık miktar eklenemez: sonuç tam sayı kalamaz."
                                .into(),
                            satir,
                            1,
                            1,
                        ...
                        .onerili(
                            "Hedefi ondalık başlat (örn. 0,0 olsun) ya da miktarı tam sayı yap."
                                .into(),
                        ));
                    }
                }
