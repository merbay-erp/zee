//! Zee yayın artefaktlarının çevrimdışı, deterministik üretim ve güven çekirdeği.
//!
...
use crate::paket_modeli::{ImzaliYayin, PaketCiktilari, YayinDosyasi};
...
pub(crate) fn paketle_dogrulanmis(
    kok: &Path,
