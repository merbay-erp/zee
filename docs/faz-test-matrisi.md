...
| Supply-chain | `test:guvenlik_kapisi_testi`<br>`test:tedarik_kapisi_testi` | — | RustSec, lisans, kilit, action pini, offline vendor ve birlesik guvenlik bulgu/surum kapisinin yurutulebilir kapisi. |
...
| Supply-chain | `test:guvenlik_kapisi_testi`<br>`test:tedarik_kapisi_testi` | — | `paket`<br>`registry`<br>`proje`<br>`muhe_kapilari` |
