...
| IO | `compiler/tests/deterministik_io_profili_testi.rs`<br>`compiler/tests/dosya_yasam_dongusu_testi.rs`<br>`compiler/tests/io_izi_testi.rs`<br>`compiler/tests/postgresql_testi.rs`<br>`compiler/tests/fixtures/postgresql-recovery-v1.tsv`<br>`compiler/src/web_yukleme.rs` | — | — | `eszamanlilik`<br>`web_guvenlik`<br>`cli`<br>`proje`<br>`uctan_uca` |
...
| IO | `test:deterministik_io_profili_testi`<br>`test:dosya_yasam_dongusu_testi`<br>`test:io_izi_testi`<br>`test:postgresql_testi`<br>`lib:ag_istemcisi::testler::`<br>`lib:kalici_dosya::tests::`<br>`lib:kalici_dosya::yasam_dongusu::tests::`<br>`lib:postgresql::havuz::testler::`<br>`lib:postgresql::testler::`<br>`bin:dil:web_yukleme::tests::` | — | Deterministik profil, replay, ag yaniti, PostgreSQL TLS/havuz/parametre/recovery/Sonuc siniri ve binary dosya yasam dongusu. |
...
| Supply-chain | `test:guvenlik_kapisi_testi`<br>`test:kurulum_testi`<br>`test:tedarik_kapisi_testi`<br>`bin:surum_artefakti:testler::` | — | RustSec, lisans, kilit, action pini, offline vendor, birlesik guvenlik bulgu/surum kapisi, tekrar uretilebilir surum artefakti ve kurulum/kaldirma tatbikatinin yurutulebilir kapisi. |
...
| End-to-end | `test:dogfood_karsilastirma_testi`<br>`test:dogfood_korpusu_testi`<br>`test:golden_testi`<br>`test:kanit_ozeti_testi` | `test:dogfood_korpusu_testi → lexer, parser, cozumleyici, tur, hir, runtime`<br>`test:golden_testi → lexer, parser, ast, cozumleyici, tur, hir, runtime, cli`<br>`test:kanit_ozeti_testi → lexer, parser, cozumleyici, tur, hir, runtime, io`<br>`test:dogfood_karsilastirma_testi → cli` | 33 golden program, gercek urun surtunmesinden dogan dogfood korpusu, ikinci urunun (kanit ozeti) hermetik tazelik kapisi ve Rust/Go esdegerlik karsilastirmasi ile kullanici yuzeyinden tam derleme ve yurutme hatti. |
| Engineering gates | `test:bagimlilik_cevrimi_testi`<br>`test:dokuman_tazelik_testi`<br>`test:katalog_testi`<br>`test:katman_mimarisi_testi`<br>`test:mimari_sinir_testi`<br>`test:panic_guvenligi_testi`<br>`test:public_api_testi`<br>`test:tani_kimligi_testi`<br>`test:uyumluluk_testi`<br>`bin:islev_egilimi:testler::`<br>`bin:faz_test_matrisi:testler::`<br>`bin:olcum:testler::`<br>`bin:soak:testler::`<br>`bin:spec_drift:testler::`<br>`bin:tani_kalitesi:testler::` | `test:public_api_testi → lexer, parser, cozumleyici, tur, hir, runtime` | Belge tani mimari panic bicim katman cevrim public API uyumluluk/deprecation, spec madde drift, uzun soak, tani kalitesi ve exact provenance/esik performans gozetim kapilarinin kendi regresyonlari. |
...
|---|---|---|---|
| Lexer | `test:fuzz_korpusu_testi`<br>`test:kacis_ve_negatif_testi` | `parser / test:bicimleyici_testi`<br>`parser / test:ifade_grameri_testi`<br>`parser / test:parser_kurtarma_testi`<br>`morfoloji / test:morfoloji_conformance_testi`<br>`morfoloji / test:morfoloji_testi`<br>`lsp / test:lsp_testi`<br>`wasm / test:playground_testi`<br>`proje / test:projeler_testi`<br>`uctan_uca / test:dogfood_korpusu_testi`<br>`uctan_uca / test:golden_testi`<br>`uctan_uca / test:kanit_ozeti_testi`<br>`muhe_kapilari / test:public_api_testi` | `parser`<br>`ast`<br>`cozumleyici`<br>`tur`<br>`hir`<br>`runtime`<br>`lsp`<br>`wasm`<br>`cli`<br>`proje`<br>`uctan_uca` |
| Parser | `test:bicimleyici_testi`<br>`test:ifade_grameri_testi`<br>`test:parser_kurtarma_testi` | `lexer / test:fuzz_korpusu_testi`<br>`lsp / test:lsp_testi`<br>`wasm / test:playground_testi`<br>`proje / test:projeler_testi`<br>`semantic_regresyon / test:semantic_regresyon_korpusu_testi`<br>`uctan_uca / test:dogfood_korpusu_testi`<br>`uctan_uca / test:golden_testi`<br>`uctan_uca / test:kanit_ozeti_testi`<br>`muhe_kapilari / test:public_api_testi` | `ast`<br>`cozumleyici`<br>`tur`<br>`hir`<br>`runtime`<br>`lsp`<br>`wasm`<br>`cli`<br>`proje`<br>`semantic_regresyon`<br>`uctan_uca` |
...
| Resolver | `test:birim_testi`<br>`test:kapsam_testi`<br>`test:semantic_kimlik_testi` | `morfoloji / test:morfoloji_conformance_testi`<br>`morfoloji / test:morfoloji_testi`<br>`lsp / test:lsp_testi`<br>`wasm / test:playground_testi`<br>`proje / test:projeler_testi`<br>`semantic_regresyon / test:semantic_regresyon_korpusu_testi`<br>`uctan_uca / test:dogfood_korpusu_testi`<br>`uctan_uca / test:golden_testi`<br>`uctan_uca / test:kanit_ozeti_testi`<br>`muhe_kapilari / test:public_api_testi` | `tur`<br>`hir`<br>`runtime`<br>`lsp`<br>`proje`<br>`uctan_uca` |
| Type checker | `test:acik_imza_testi`<br>`test:cagri_cikarimi_testi`<br>`test:daraltma_testi`<br>`test:ffi_sinir_testi`<br>`test:intrinsic_lowering_testi`<br>`test:koleksiyon_testi`<br>`test:sonuc_donusu_testi` | `lsp / test:lsp_testi`<br>`wasm / test:playground_testi`<br>`proje / test:projeler_testi`<br>`semantic_regresyon / test:semantic_regresyon_korpusu_testi`<br>`uctan_uca / test:dogfood_korpusu_testi`<br>`uctan_uca / test:golden_testi`<br>`uctan_uca / test:kanit_ozeti_testi`<br>`muhe_kapilari / test:public_api_testi` | `hir`<br>`runtime`<br>`lsp`<br>`wasm`<br>`cli`<br>`proje`<br>`semantic_regresyon`<br>`uctan_uca` |
| Typed HIR | `test:hir_modeli_testi`<br>`lib:hir::testler::` | `lsp / test:lsp_testi`<br>`wasm / test:playground_testi`<br>`proje / test:projeler_testi`<br>`semantic_regresyon / test:semantic_regresyon_korpusu_testi`<br>`uctan_uca / test:dogfood_korpusu_testi`<br>`uctan_uca / test:golden_testi`<br>`uctan_uca / test:kanit_ozeti_testi`<br>`muhe_kapilari / test:public_api_testi` | `runtime`<br>`lsp`<br>`wasm`<br>`semantic_regresyon`<br>`uctan_uca` |
...
| Runtime | `test:dene_ve_sure_testi`<br>`test:metin_testi`<br>`test:ondalik_testi`<br>`test:ozyineleme_testi`<br>`test:siralama_testi`<br>`test:yapilandirilmis_hata_testi`<br>`lib:ondalik::testler::`<br>`lib:zaman::testler::` | `web_guvenlik / test:web_testi`<br>`wasm / test:playground_testi`<br>`proje / test:projeler_testi`<br>`semantic_regresyon / test:semantic_regresyon_korpusu_testi`<br>`uctan_uca / test:dogfood_korpusu_testi`<br>`uctan_uca / test:golden_testi`<br>`uctan_uca / test:kanit_ozeti_testi`<br>`muhe_kapilari / test:public_api_testi` | `io`<br>`eszamanlilik`<br>`web_guvenlik`<br>`wasm`<br>`cli`<br>`semantic_regresyon`<br>`uctan_uca` |
| IO | `test:deterministik_io_profili_testi`<br>`test:dosya_yasam_dongusu_testi`<br>`test:io_izi_testi`<br>`test:postgresql_testi`<br>`lib:ag_istemcisi::testler::`<br>`lib:kalici_dosya::tests::`<br>`lib:kalici_dosya::yasam_dongusu::tests::`<br>`lib:postgresql::havuz::testler::`<br>`lib:postgresql::testler::`<br>`bin:dil:web_yukleme::tests::` | `web_guvenlik / test:web_testi`<br>`uctan_uca / test:kanit_ozeti_testi` | `eszamanlilik`<br>`web_guvenlik`<br>`cli`<br>`proje`<br>`uctan_uca` |
...
| Supply-chain | `test:guvenlik_kapisi_testi`<br>`test:kurulum_testi`<br>`test:tedarik_kapisi_testi`<br>`bin:surum_artefakti:testler::` | — | `paket`<br>`registry`<br>`proje`<br>`muhe_kapilari` |
...
| CLI | `test:io_izi_cli_testi` | `proje / test:proje_testi`<br>`proje / test:projeler_testi`<br>`uctan_uca / test:golden_testi`<br>`uctan_uca / test:dogfood_karsilastirma_testi` | `proje`<br>`uctan_uca` |
...
| End-to-end | `test:dogfood_karsilastirma_testi`<br>`test:dogfood_korpusu_testi`<br>`test:golden_testi`<br>`test:kanit_ozeti_testi` | — | — |
| Engineering gates | `test:bagimlilik_cevrimi_testi`<br>`test:dokuman_tazelik_testi`<br>`test:katalog_testi`<br>`test:katman_mimarisi_testi`<br>`test:mimari_sinir_testi`<br>`test:panic_guvenligi_testi`<br>`test:public_api_testi`<br>`test:tani_kimligi_testi`<br>`test:uyumluluk_testi`<br>`bin:islev_egilimi:testler::`<br>`bin:faz_test_matrisi:testler::`<br>`bin:olcum:testler::`<br>`bin:soak:testler::`<br>`bin:spec_drift:testler::`<br>`bin:tani_kalitesi:testler::` | — | — |
